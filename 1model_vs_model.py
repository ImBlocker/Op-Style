...
if args.model_type == "ppo_gridnet_large":
    from wan1 import Agent, MicroRTSStatsRecorder
        ...
        def process_data(game_history):
            ...
            for item in game_history:
                processed_item = {
                    # 'step': item['step'],
                    # 'p1': {
                    #     'observations': tensor_to_list(item['p1']['observations']),
                    #     'actions': tensor_to_list(item['p1']['actions'])
                    # },
                    # 'p2': {
                    #     'observations': tensor_to_list(item['p2']['observations']),
                    #     'actions': tensor_to_list(item['p2']['actions'])
                    # },
...
if __name__ == "__main__":
    ...
    path1 = 'models/ppogdi/agent.pt'
    path2 = 'models/ppogdi/agent.pt'
