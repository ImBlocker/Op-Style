from coco_2.data_process import state_get, highaction_get, lowaction_get, middleaction_get, get_datasets_single, data_get
from coco_2.networks import HighActionNetwork, LowActionNetwork_simple, LowActionNetwork_complex, LowActionNetwork_simplest, \
    MiddleActionNetwork
# from coco_2.trainer import HighActionModelTrainer, LowActionModelTrainer, MiddleActionModelTrainer
import torch
...
def forward_compute(state_merge_pos_input):
    TypeAction_model = type_net_build("coco_2/results_type_model/type_action_model_99.pth")
    ...
    TurnAction_model = turn_net_build("coco_2/results_turn_model/turn_action_model_99.pth")
