...
state_file_path = '../data/heavy/heavy_state.csv'
pos_file_path = '../data/heavy/heavy_pos.csv'
middleaction_file_path = '../data/heavy/heavy_middle_action.csv'
lowaction_file_path = '../data/heavy/heavy_low_action.csv'
